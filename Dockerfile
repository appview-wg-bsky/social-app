...
ARG EXPO_PUBLIC_BSKY_APP_ACCOUNT_DID
ENV EXPO_PUBLIC_BSKY_APP_ACCOUNT_DID=${EXPO_PUBLIC_BSKY_APP_ACCOUNT_DID}
ARG EXPO_PUBLIC_BSKY_CHAT_DID_REFERENCE
ENV EXPO_PUBLIC_BSKY_CHAT_DID_REFERENCE=${EXPO_PUBLIC_BSKY_CHAT_DID_REFERENCE}
ARG EXPO_PUBLIC_BSKY_APP_HOSTNAME
ENV EXPO_PUBLIC_BSKY_APP_HOSTNAME=${EXPO_PUBLIC_BSKY_APP_HOSTNAME}
ARG EXPO_PUBLIC_BSKY_VIDEO_HOSTNAME
ENV EXPO_PUBLIC_BSKY_VIDEO_HOSTNAME=${EXPO_PUBLIC_BSKY_VIDEO_HOSTNAME}
